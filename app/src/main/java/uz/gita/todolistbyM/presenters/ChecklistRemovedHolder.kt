...
class ChecklistRemovedHolder(private val view: View, private val listener:
ListenerForChecklistRemoved):
    RecyclerView.ViewHolder(view) {
    private val itemCheckedIW=view.findViewById<ImageView>(R.id.checkbox_item_checklist_deleted)
    ...
    private val backReturn=view.findViewById<ImageView>(R.id.back_return_item_checklist_deleted)
    ...
    fun bind(dataTask: CheckListEntity){
        ...
        itemCheckedIW.setOnClickListener(){
            if (dataTask.checkState==0) {
                itemCheckedIW.setImageResource(R.drawable.ic_check_circle)
                dataTask.checkState=1
                setText(dataTask)
            }
            else {
                itemCheckedIW.setImageResource(R.drawable.ic_unchecked)
